...
function Rewards() {
  ...
  const loadBlockchainData = async () => {
    ...
    if(networkId === 3) {
      ...
      // .mint(accounts[0], web3.utils.toWei("10" ,'ether'))
  ...
  return (
                        ...
                        {show &&
                          <div className="row justify-content-center py-5"> 
                            ...
                            <div className="col-sm-1 d-flex align-items-end">
                              <button type="btn" className="btn btn-custom-green" id="foucet-token-btn" onClick={sendToken}>
                                Redeem
                              </button>
                            </div>
                          </div> 
    ...
    <button className="btn btn-custom-green" onClick={sendToken}>Send Tokens</button>
    <Footer />
    </>
  );
}
